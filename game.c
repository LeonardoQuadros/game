...
void draw_map()
{
    ...
    for(i=0; i<1200; i+=30)
    {
        ...
        {
            if(map[i][j] == '|')
                al_draw_scaled_bitmap(wall, 0, 0, 19, 16, j, i, 30, 30, 0);
            if(map[i][j] == 'R')
                al_draw_scaled_bitmap(stone, 0, 0, 32, 32, j, i, 30, 30, 0);
            if(map[i][j] == 'O')
                al_draw_scaled_bitmap(gem, 0, 0, 26, 22, j, i, 30, 30, 0);
            if(map[i][j] == 'X')
                al_draw_scaled_bitmap(position[player.pos], 0, 0, 18, 29, j, i, 30, 30, 0);
        }
    }
}
...
int main()
{
    ...
    buffer = al_create_bitmap(1500, 1200);
