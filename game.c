...
void draw_map()
{
    ...
    for(i=0; i<120; i+=30)
    {
        for(j=0; j<150; j+=30)
        {
            ...
            if(map[i][j] == 'R')
                al_draw_scaled_bitmap(stone, 0, 0, 32, 32, 10*j, 10*i, 30, 30, 0);
            if(map[i][j] == 'O')
                al_draw_scaled_bitmap(gem, 0, 0, 26, 22, 10*j, 10*i, 30, 30, 0);
            if(map[i][j] == 'X')
                al_draw_scaled_bitmap(position[player.pos], 0, 0, 18, 29, 10*j, 10*i, 30, 30, 0);
        }
    }
}
